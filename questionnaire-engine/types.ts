...
export type QuestionId =
  ...
  | "hasSavingsBuffer"
  | "savingsBufferAmount"
  // Feature B — Freelancer many-clients
  | "freelancerClientBase"
  | "freelancerClientCount"
  | "freelancerClientPlatforms"
  | "freelancerNotableClients"
  // Feature C — Business owner revenue-type
  | "businessIncomeType"
  | "businessIsRegisteredEntity"
  ...
  | "creatorPlatforms"
  | "creatorIncomeType"
  | "businessOtherDescription"
  // Feature A — Employee employer-switch
  | "hasChangedEmployerRecently"
  | "previousEmployerName"
  | "previousEmployerJobTitle"
  | "previousEmployerStartDate"
  | "previousEmployerEndDate"
  | "previousEmployerMonthlyIncome"
  | "previousEmployerIncomeCurrency"
  | "hadEmploymentGap"
