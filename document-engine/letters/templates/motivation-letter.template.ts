/**
 * Motivation Letter — Product Spec (v1).md §4. Text lives here as data
 * (ordered paragraphs with {{placeholders}}), never inline in a component
 * or route. NEVER mention "NomadPacket" anywhere in this text (AGENTS.md
 * §2) — this letter must read as the applicant's own words to a
 * consulate.
 */
